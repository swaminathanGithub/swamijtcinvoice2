...
describe("sendAiRequest", () => {
    ...
    it("not BAS, should successfully send an ai request with no config", async () => {
        // Setup
        const mockLandscape = "test-landscape";
        const mockJwt = "test-jwt";
        const mockIasJwt = "test-ias-jwt";
        const mockRequest = {
            path: "/test-path",
            method: "GET",
        };
    ...
    it("not BAS, should successfully send an ai request with custom resource group", async () => {
        ...
        (0, chai_1.expect)(sendRequestStub.firstCall.args[0]).to.deep.include({
            jwt: mockJwt,
            config: Object.assign(Object.assign({}, mockRequest.config), { headers: Object.assign(Object.assign({}, mockRequest.config.headers), { "AI-Resource-Group": "custom-rg", "ias-authorization": mockIasJwt }) }),
            method: mockRequest.method,
            url: {
                domain: `https://${tenantMetadata.host}`,
                path: `secure-outbound-connectivity/llm${mockRequest.path}`,
