...
exports.initialSymbol = Symbol('initial');
/**
 ...
 */
function lazy(converter, object, property, init) {
    let _value = exports.initialSymbol;
    Object.defineProperty(object, property, {
        enumerable: true,
        get() {
            if (_value === exports.initialSymbol) {
                _value = init();
            }
            return _value;
        },
 ...
 * @param parserOutput
 */
function mergeRawMetadata(baseMetadata, parserOutput) {
    var _a;
    var _b;
    ...
    (_a = (_b = baseMetadata.schema).entityContainers) !== null && _a !== void 0 ? _a : (_b.entityContainers = {});
