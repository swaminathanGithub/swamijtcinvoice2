...
class FilesystemStore {
    ...
    async read({ entityName, id }) {
        const name = (0, utils_1.toPersistenceName)(entityName);
        if (!name) {
    ...
    _readAll(entityName) {
        let rawContents;
        try {
            const configPath = node_path_1.default.join(this.storeDirectory, `${entityName}.json`);
    ...
    writeToFile(entityName, entities) {
        ...
        const filename = (0, utils_1.getEntityFileName)(entityName);
        try {
...
function getFilesystemWatcherFor(entityName, callback, options = {}) {
    const watchPath = node_path_1.default.join((0, exports.basedir)(options), (0, utils_1.getEntityFileName)(entityName));
    if ((0, node_fs_1.existsSync)(watchPath)) {
        return node_fs_1.default.watch(watchPath, undefined, () => {
            callback(entityName);
        });
    }
    else {
