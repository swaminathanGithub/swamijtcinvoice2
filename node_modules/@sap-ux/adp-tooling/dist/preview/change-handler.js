...
function addXmlFragment(basePath, change, fs, logger, additionalChangeInfo) {
    ...
    const fullPath = (0, node_path_1.join)(basePath, project_access_1.DirName.Changes, fragmentPath);
...
async function addControllerExtension(rootPath, basePath, change, fs, logger) {
    ...
    const fileName = (0, node_path_1.basename)(codeRef, '.js');
    ...
    const tmplPath = (0, node_path_1.join)(__dirname, '../../templates/rta', tmplFileName);
    try {
        ...
        fs.write((0, node_path_1.join)(basePath, project_access_1.DirName.Changes, project_access_1.DirName.Coding, fullName), template);
    }
    catch (error) {
...
async function addAnnotationFile(webappPath, projectRoot, change, fs, logger, provider) {
    ...
    const fullPath = (0, node_path_1.join)(webappPath, project_access_1.DirName.Changes, ...annotationUriSegments);
    try {
