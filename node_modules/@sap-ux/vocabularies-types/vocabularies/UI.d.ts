...
export type ReferenceFacet = ComplexType & Omit<Facet, '$Type'> & {
    ...
    */
    Target: Edm.AnnotationPath<Communication.Address | Communication.Contact | Badge | Chart | Contacts | DataPoint | FieldGroup | GeoLocation | GeoLocations | HeaderInfo | Identification | KPI | LineItem | MediaResource | Note | PresentationVariant | SelectionFields | SelectionPresentationVariant | StatusInfo>;
};
/**
...
export type PresentationVariantType = ComplexType & {
    ...
    */
    Visualizations: Edm.AnnotationPath<Chart | DataPoint | LineItem>[];
    /**
