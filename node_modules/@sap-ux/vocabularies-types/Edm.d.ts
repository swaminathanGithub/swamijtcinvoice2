...
import type { ActionAnnotations, ActionImportAnnotations, AnnotationAnnotations, CollectionAnnotations, ComplexTypeAnnotations, EntityContainerAnnotations, EntitySetAnnotations, EntityTypeAnnotations, EnumTypeAnnotations, FunctionAnnotations, FunctionImportAnnotations, IncludeAnnotations, NavigationPropertyAnnotations, ParameterAnnotations, PropertyAnnotations, PropertyValueAnnotations, RecordAnnotations, ReferenceAnnotations, ReturnTypeAnnotations, SchemaAnnotations, SingletonAnnotations, TermAnnotations, TypeDefinitionAnnotations } from './vocabularies/Edm_Types';
...
type PrimitiveTypeCast<P, G> = (P extends boolean ? boolean | (Boolean & G) : never) | (P extends number ? number | (Number & G) : never) | (P extends string ? string | (String & G) : never) | (P & G);
export type AnnotationTerm<P> = PrimitiveTypeCast<P, {
...
export type ConditionalCheck = OrConditionalExpression | AndConditionalExpression | NotConditionalExpression | EqConditionalExpression | NeConditionalExpression | GtConditionalExpression | GeConditionalExpression | LtConditionalExpression | LeConditionalExpression | InConditionalExpression | HasConditionalExpression | NegConditionalExpression | AddConditionalExpression | SubConditionalExpression | MulConditionalExpression | DivConditionalExpression | DivByConditionalExpression | ModConditionalExpression;
export type ConditionalCheckOrValue = null | string | number | boolean | ConditionalCheck | PathConditionExpression<string | number | boolean>;
...
export type DynamicAnnotationExpression<P> = PathAnnotationExpression<P> | ApplyAnnotationExpression<P> | AndAnnotationExpression<P> | OrAnnotationExpression<P> | EqAnnotationExpression<P> | NeAnnotationExpression<P> | NotAnnotationExpression<P> | GtAnnotationExpression<P> | GeAnnotationExpression<P> | LtAnnotationExpression<P> | LeAnnotationExpression<P> | IfAnnotationExpression<P> | InAnnotationExpression<P> | HasAnnotationExpression<P> | NegAnnotationExpression<P> | AddAnnotationExpression<P> | SubAnnotationExpression<P> | MulAnnotationExpression<P> | DivAnnotationExpression<P> | DivByAnnotationExpression<P> | ModAnnotationExpression<P> | ConstantExpression<P>;
...
export type AnyAnnotation = EnumTypeAnnotations | PropertyValueAnnotations | IncludeAnnotations | ReferenceAnnotations | ActionAnnotations | FunctionImportAnnotations | ActionImportAnnotations | TypeDefinitionAnnotations | SingletonAnnotations | EntityContainerAnnotations | FunctionAnnotations | ReturnTypeAnnotations | ParameterAnnotations | ComplexTypeAnnotations | TermAnnotations | RecordAnnotations | SchemaAnnotations | AnnotationAnnotations | EntitySetAnnotations | EntityTypeAnnotations | PropertyAnnotations | NavigationPropertyAnnotations;
...
export type RemoveAnnotationAndType<T> = {
    [K in keyof Omit<T, 'annotations' | 'targetType' | 'isKey' | 'resolvePath' | 'entityType' | 'navigationProperties' | 'navigationPropertyBinding' | 'entitySets' | 'singletons' | 'actionImports' | 'action'>]: T[K] extends object ? T[K] extends Array<infer Item> ? RemoveAnnotationAndType<Item>[] : RemoveAnnotationAndType<T[K]> : T[K];
};
